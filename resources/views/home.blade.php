...
<div class="container mt-5">
    ...
    @endif
            <!-- message close -->
            <div class="card">
                <div class="card-header">{{ __('Blog post page') }}</div>
                ...
                <div class="container">
                    ...
                    <form method="post" action="{{ route('blogPostStore') }}" enctype="multipart/form-data">
                        ...
                        <input type="post_title" class="form-control" id="post_title" placeholder="post_title" name="post_title">
                        </div>
                        <div class="form-group">
                        <label for="post_content">post_content:</label>
                        <input type="post_content" class="form-control" id="post_content" placeholder="post_content" name="post_content">
                        </div>
                        <div class="form-group">
                        <label for="post_place">post_place:</label>
                        <input type="post_place" class="form-control" id="post_place" placeholder="post_place" name="post_place">
                        </div>
                        <div class="form-group">
                        <label for="blog_image">blog_image:</label>
                        <input type="file" class="form-control" id="blog_image" placeholder="blog_image" name="blog_image">
                        </div>
                        <br>
